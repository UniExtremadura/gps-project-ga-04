...
class TESTHU5 {
    ...
    fun tESTHU5() {
        ...
        val textView = onView(
            allOf(
                withId(android.R.id.summary), withText("Modo Claro"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("Modo Claro")))
        ...
        val textView2 = onView(
            allOf(
                withId(android.R.id.summary), withText("Modo Oscuro"),
                withParent(withParent(IsInstanceOf.instanceOf(android.widget.LinearLayout::class.java))),
                isDisplayed()
            )
        )
        textView2.check(matches(withText("Modo Oscuro")))
    }
