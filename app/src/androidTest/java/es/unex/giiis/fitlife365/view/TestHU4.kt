...
class TestHU4 {
    ...
    fun testHU4() {
        ...
        val bottomNavigationItemView0 = onView(
            allOf(
        ...
        //ir a crear rutina
        bottomNavigationItemView0.perform()
        ...
        val materialTextView = onView(
            allOf(
                withId(R.id.usernameText), withText("PRUEBA"),
                childAtPosition(
                    allOf(
        ...
        appCompatEditText5.perform(scrollTo(), replaceText("PRUEBA"))

        val appCompatEditText6 = onView(
            allOf(
                withId(android.R.id.edit), withText("PRUEBA"),
                childAtPosition(
                    childAtPosition(
                        withClassName(`is`("android.widget.ScrollView")),
                        0
        ...
        appCompatEditText7.perform(scrollTo(), replaceText("prueba"))
