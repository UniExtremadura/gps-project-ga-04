...
class TestHU16 {
    ...
    fun testHU16() {
        ...
        val materialTextView = onView(
            allOf(
                withId(R.id.usernameTextEvS), withText("Ev.S"),
                childAtPosition(
                    allOf(
        ...
        textView.check(matches(withText("Datos del perfil")))
        ...
        appCompatEditText11.perform(replaceText("70"))
        ...
        textView2.check(matches(withText("Mis Rutinas")))
        ...
        editText.check(matches(withText("70")))
        ...
        textView3.check(matches(withText("Mis Rutinas")))
    }
