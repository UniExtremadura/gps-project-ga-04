...
class TestHU11 {
    ...
    fun testHU11() {
        ...
        val materialButton5 = onView(
            allOf(
                withId(R.id.buttonConsejos), withText("Consejos"),
                childAtPosition(
                    childAtPosition(
        ...
        val textView = onView(
            allOf(
                withId(R.id.mensajeTexto), withText("Consejos de seguridad"),
                withParent(withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java))),
                isDisplayed()
            )
        )
        textView.check(matches(withText("Consejos de seguridad")))

        val spinner = onView(
            allOf(
                withId(R.id.spinnerTemas),
                withParent(withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java))),
                isDisplayed()
            )
        )
        ...
        val button = onView(
            allOf(
                withId(R.id.botonAgregarConsejo), withText("+"),
                withParent(withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java))),
                isDisplayed()
            )
        )
        ...
        val button2 = onView(
            allOf(
                withId(R.id.botonVolver), withText("Volver al entrenador personal"),
                withParent(withParent(IsInstanceOf.instanceOf(android.view.ViewGroup::class.java))),
                isDisplayed()
            )
        )
